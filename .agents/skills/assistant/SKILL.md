...
name: assistant
description: >
  실습 진행 도우미 "초록이". 학생이 "초록이", "초록아", "다음 단계",
  "다음 뭐 해", "어떻게 실행해", "이 결과가 무슨 뜻이야", "도와줘",
  "어디부터야", "실제(모의투자)로 돌려보고 싶어", "자동으로 돌리고 싶어",
  "리캡", "한입", "회고해 줘", "방금 뭐 배웠어"
  라고 하면 반드시 이 스킬로 한 단계씩 안내한다.
  "수업 자료 업데이트 해 줘" "실습 환경 설치해 줘" 는 environment 스킬.
  "스킬과 MCP 가 뭐가 다른지 가르쳐 줘" 는 skill-vs-mcp 스킬.
  에러·안 됨은 troubleshooting 스킬.
---
