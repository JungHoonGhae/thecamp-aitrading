...
name: environment
description: >
  실습 폴더를 받고, 수업 자료를 최신으로 맞추고, 준비됐는지 확인하는 유일한 스킬.
  목적어가 있는 말이 정규다. "수업 자료 업데이트 해 줘", "수업자료 업데이트해줘",
  "실습 폴더 업데이트 해 줘", "실습 환경 설치해 줘", "실습 환경 세팅해 줘",
  "실습 환경 준비됐는지 확인해 줘" 라고 하면 반드시 이 스킬을 쓴다.
  짧은 말("업데이트 해 줘", "맞춰 줘", "최신으로", "설치해 줘", "업뎃",
  "강사가 업데이트했대", "pull", "git pull", "저장소 받아", "환경 세팅",
  "verify", "폴더가 어디야")도 여기다. git 명령을 학생에게 시키지 않는다.
  다음 단계·숙제·에러 고치기가 아니라, 폴더를 받거나 맞추거나 점검할 때 쓴다.
---
